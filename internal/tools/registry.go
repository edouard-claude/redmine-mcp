...
func RegisterAll(s *server.MCPServer, client *redmine.Client) {
	...
	registerSearchUsers(s, client)
	registerListRoles(s, client)
	registerListGroups(s, client)
	registerListProjectMembers(s, client)
	registerCreateIssue(s, client)
	registerUpdateIssue(s, client)
	registerUpdateComment(s, client)
	registerCreateUser(s, client)
	registerAddProjectMember(s, client)
	registerAddGroupUser(s, client)
}
